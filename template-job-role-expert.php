<?php
/**
 * Template Name: Job Role Expert Guide
 * Description: Expert content page for individual job roles
 * Use this for: Electrical Engineer, Project Manager, HV Technician, etc.
 *
...
while (have_posts()) :
    ...
    // Get parent category (sector) page
